...
class CaroUI:
    def __init__(self, root):
        ...
        self.root.geometry("600x600")  # Đặt kích thước cửa sổ
        ...
        self.size_label = tk.Label(root, text="Chọn kích thước bàn cờ:", font=self.custom_font, fg=self.text_color,
                                   bg=self.bg_color)
        ...
        self.size5_radio = tk.Radiobutton(self.size_frame, text="5x5", variable=self.size_var, value=5,
                                          font=self.custom_font, fg=self.text_color, bg=self.bg_color,
                                          selectcolor=self.bg_color)
        self.size7_radio = tk.Radiobutton(self.size_frame, text="7x7", variable=self.size_var, value=7,
                                          font=self.custom_font, fg=self.text_color, bg=self.bg_color,
                                          selectcolor=self.bg_color)
        self.size11_radio = tk.Radiobutton(self.size_frame, text="19x19", variable=self.size_var, value=19,
                                           font=self.custom_font, fg=self.text_color, bg=self.bg_color,
                                           selectcolor=self.bg_color)
        ...
        # Chọn chế độ chơi
        self.mode_label = tk.Label(root, text="Chọn chế độ chơi", font=self.custom_font, fg=self.text_color,
                                   bg=self.bg_color)
        self.mode_label.pack(pady=10)
        self.mode_var = tk.StringVar(value="ai")
        self.mode_frame = tk.Frame(root, bg=self.bg_color)
        self.mode_frame.pack()
        self.pvp_radio = tk.Radiobutton(self.mode_frame, text="Người đấu Người", variable=self.mode_var, value="pvp",
                                        font=self.custom_font, fg=self.text_color, bg=self.bg_color,
                                        selectcolor=self.bg_color)
        self.ai_radio = tk.Radiobutton(self.mode_frame, text="Người đấu A.I", variable=self.mode_var, value="ai",
                                       font=self.custom_font, fg=self.text_color, bg=self.bg_color,
                                       selectcolor=self.bg_color)
